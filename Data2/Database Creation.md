```
DROP DATABASE IF EXISTS `cis467_final_project`;


/*******************************************************************************
   Create database
********************************************************************************/
CREATE DATABASE `cis467_final_project`;
...
CREATE TABLE Employees (
	...
	(
		ReportsTo
	) REFERENCES cis467_final_project.Employees (
		EmployeeID
	)
);

 CREATE  INDEX LastName ON cis467_final_project.Employees(LastName);

 CREATE  INDEX PostalCode ON cis467_final_project.Employees(PostalCode);
...
CREATE TABLE Categories (
 ...
 CREATE  INDEX CategoryName ON cis467_final_project.Categories(CategoryName);
...
CREATE TABLE Customers (
 ...
 CREATE  INDEX City ON cis467_final_project.Customers(City);

 CREATE  INDEX CompanyName ON cis467_final_project.Customers(CompanyName);

 CREATE  INDEX PostalCode ON cis467_final_project.Customers(PostalCode);

 CREATE  INDEX Region ON cis467_final_project.Customers(Region);
...
CREATE TABLE Suppliers (
 ...
 CREATE  INDEX CompanyName ON cis467_final_project.Suppliers(CompanyName);

 CREATE  INDEX PostalCode ON cis467_final_project.Suppliers(PostalCode);
...
CREATE TABLE Orders (
	...
	(
		CustomerID
	) REFERENCES cis467_final_project.Customers (
		CustomerID
	),
	...
	(
		ShipVia
	) REFERENCES cis467_final_project.Shippers (
		ShipperID
	)
);

 CREATE  INDEX CustomerID ON cis467_final_project.Orders(CustomerID);

 CREATE  INDEX CustomersOrders1 ON cis467_final_project.Orders(OrderID);

 CREATE  INDEX EmployeeID ON cis467_final_project.Orders(EmployeeID);

  CREATE  INDEX OrderDate ON cis467_final_project.Orders(OrderDate);

 CREATE  INDEX ShippedDate ON cis467_final_project.Orders(ShippedDate);

 CREATE  INDEX ShippersOrders ON cis467_final_project.Orders(ShipVia);

 CREATE  INDEX ShipPostalCode ON cis467_final_project.Orders(ShipPostalCode);
...
CREATE TABLE Products (
	...
	(
		CategoryID
	) REFERENCES cis467_final_project.Categories (
		CategoryID
	),
	CONSTRAINT FK_Products_Suppliers FOREIGN KEY 
	(
		SupplierID
	) REFERENCES cis467_final_project.Suppliers (
		SupplierID
	)
	
);

 CREATE  INDEX CategoriesProducts1 ON cis467_final_project.Products(ProductID);

 CREATE  INDEX CategoryID ON cis467_final_project.Products(CategoryID);

 CREATE  INDEX ProductName ON cis467_final_project.Products(ProductName);

 CREATE  INDEX SupplierID ON cis467_final_project.Products(SupplierID);
...
CREATE TABLE Order_Details (
	...
	(
		OrderID
	) REFERENCES cis467_final_project.Orders (
		OrderID
	),
	CONSTRAINT FK_Order_Details_Products FOREIGN KEY 
	(
		ProductID
	) REFERENCES cis467_final_project.Products (
		ProductID
	)
	
);

 CREATE  INDEX OrderID ON cis467_final_project.Order_Details(OrderID);



 CREATE  INDEX ProductID ON cis467_final_project.Order_Details(ProductID);
...
CREATE TABLE cis467_final_project.Region 
	( RegionID int NOT NULL ,
	RegionDescription char (50) NOT NULL 
) ;


CREATE TABLE cis467_final_project.Territories 
...
CREATE TABLE cis467_final_project.EmployeeTerritories 
...
ALTER TABLE Territories
	...
	(
		RegionID
	) REFERENCES cis467_final_project.Region (
		RegionID
	);
...
ALTER TABLE EmployeeTerritories	
	...
	(
		TerritoryID
	) REFERENCES cis467_final_project.Territories (
		TerritoryID
	);
